...
public static class DataLoader
{
    public static void LoadDummyData(InventoryVM inventoryViewModel, EmployeeVM employeeViewModel)
    {
        ...
        // 2. Instantiate Role ViewModels (Auto-registers to RoleVM.AllRoles)
        ...
        {
            mainViewModel.RootDepartments.Add(new DepartmentNodeVM(deptModel));
        }
        ...
        {
            mainViewModel.Employees.Add(new EmployeeVM(empModel));
        }

        // 5. Load Hardware Assets
        LoadHardwares(inventoryViewModel, mainViewModel.Employees);
    }
